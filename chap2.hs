...
-- Define a function twoFiveOne :: Pitch → Dur → Music Pitch such that twoFiveOne p d constructs a ii-V-I chord progression in the key whose major scale begins on the pitch p (i.e., the first degree of the major scale on which the progression is being constructed), 
